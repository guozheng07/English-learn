...
The basic package is very good value for the money. 基础套餐有很高的性价比。
...
**Neither** 形成了两个事物之间的否定联系。 **Neither package** is really a great value for the money.	两个套餐都不是很划算。
...
Benny
### 录音
Neither is really a good value for the money. 这两者都不是物有所值。
...
## 表达 大的数字
我们通常不会在**million**，**thousand**和**hundred**结束时放**s** 。
...
The price is **105,000** – a good value for money. 价格为 105,000 - 物有所值。
...
### 录音
If I need to change my package, what do I do? 要是我们需要更换套餐，我怎么做？

What if we have slow speed? 要是我们网速慢，那怎么办？

If we have a problem, who do we contact? 要是我们碰到问题，我们联系谁？

If we need help, what's the response time? 要是我们需要帮助，响应时间是多久？
...
Is your help line 24 hours? **I mean**, if we have a problem, we can call any time? 你们的求助热线是 24 小时开通吗？我是说，要是我们碰到问题，可以随时拨打吗？
