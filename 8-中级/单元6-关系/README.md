...
当谈论人们之间是何种关系时，使用each other和one another。**Each other指的是两个人。one another指的是两个以上的人**。 	 
...
### 单词排序
People have commented that he seems quite.
...
## 最终任务 给出印象
你的老板问你某些人在你的团队如何。 请听音频并录制 正确的回答。
# 3 建立融洽关系
## 语法 给出更多的信息
...
### 录音
We go out for dinner when there's a special occasion. 当有特殊场合时，我们出去吃晚饭。
...
您可以使用**right** ， **um** 和 **uh-huh** 等单词和声音来表明您理解或同意所说的内容 
