...
你通过使用助动词**have**以及一个叫做过去分词的动词形式构成，例如**done**（来自 **do** ），**gone**（来自 **go**）或 **made**（来自**make**）。
### 正在持续的动作
...
### 选词填空
I've finally **completed**（complete、completing） the new designs.

What have you **doing**（been doing、did） this week?

I **have been** （has been、have being） focusing on the Butler account.

Have you **finished**（been finished、finishing） the presentation?

I've **done**（did、doing） all my work for this week.

How long have you **known**（knew、been knowing ） him?
### 录音
...
## 最终任务 联络更新会议
你的经理要开一个联络更新会议。回答他的有关你的工作的问题。 请听音频并录制 正确的回答。
# 2 谈论将来的计划
## 词汇 谈论希望和梦想的动词
build 建设  
...
She really wants to **make a difference** in the world.	她非常希望改变世界。
...
### 选词填空
Hailey's an excellent veterinarian. She really **made**（got、did）a difference for Izzy, our cat.

Do you make enough money to **support**（build、make）yourself?

This fabric is so cool! They **recycled**（changed opened） plastic bottles to make it.

If we open more parks, we can **plant**（recycle、build）more trees.

This city is so polluted! We need to **change**（support、recycle）the way we live.
### 录音
...
JAMES: Wow. **If you did** that, i**t would be** very meaningful work. It would change people's lives. There are so many elderly people who need help.
